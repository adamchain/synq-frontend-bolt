...
export default function initModels(sequelize) {
  const AnimalControlLicensing = _AnimalControlLicensing.init(
    sequelize,
    DataTypes
  );
  ...
  const ExamAnesthesiaGenCatheterLoc = _ExamAnesthesiaGenCatheterLoc.init(
    sequelize,
    DataTypes
  );
  const ExamAnesthesiaGenIvFluidType = _ExamAnesthesiaGenIvFluidType.init(
    sequelize,
    DataTypes
  );
  const ExamAnesthesiaMed = _ExamAnesthesiaMed.init(sequelize, DataTypes);
  const ExamAnesthesiaMedRoute = _ExamAnesthesiaMedRoute.init(
    sequelize,
    DataTypes
  );
  const ExamAnesthesiaMedType = _ExamAnesthesiaMedType.init(
    sequelize,
    DataTypes
  );
  const ExamAnesthesiaMedUnit = _ExamAnesthesiaMedUnit.init(
    sequelize,
    DataTypes
  );
  const ExamAnesthesiaVitalTrack = _ExamAnesthesiaVitalTrack.init(
    sequelize,
    DataTypes
  );
  const ExamAnesthesiaVitalTrackProps = _ExamAnesthesiaVitalTrackProps.init(
    sequelize,
    DataTypes
  );
  const ExamAnesthesiaVitalTrackStatus = _ExamAnesthesiaVitalTrackStatus.init(
    sequelize,
    DataTypes
  );
  const ExamAnesthesiaVitalTrackValue = _ExamAnesthesiaVitalTrackValue.init(
    sequelize,
    DataTypes
  );
  const ExamCategoryMeasurement = _ExamCategoryMeasurement.init(
    sequelize,
    DataTypes
  );
  const ExamCategoryProp = _ExamCategoryProp.init(sequelize, DataTypes);
  const ExamCategoryValueProp = _ExamCategoryValueProp.init(
    sequelize,
    DataTypes
  );
  const ExamFreeformMeasurement = _ExamFreeformMeasurement.init(
    sequelize,
    DataTypes
  );
  const ExamFreeformProp = _ExamFreeformProp.init(sequelize, DataTypes);
  const ExamNumericMeasurement = _ExamNumericMeasurement.init(
    sequelize,
    DataTypes
  );
  ...
  const InventoryCsubstanceType = _InventoryCsubstanceType.init(
    sequelize,
    DataTypes
  );
  const InventoryDetail = _InventoryDetail.init(sequelize, DataTypes);
  const InventoryExpirationPeriod = _InventoryExpirationPeriod.init(
    sequelize,
    DataTypes
  );
  ...
  const InventoryPatientReminder = _InventoryPatientReminder.init(
    sequelize,
    DataTypes
  );
  const InventoryPatientReminderUser = _InventoryPatientReminderUser.init(
    sequelize,
    DataTypes
  );
  const InventoryPatientReminderUserGroup =
    _InventoryPatientReminderUserGroup.init(sequelize, DataTypes);
  ...
  const InventoryReminderPeriod = _InventoryReminderPeriod.init(
    sequelize,
    DataTypes
  );
  const InventoryReminderType = _InventoryReminderType.init(
    sequelize,
    DataTypes
  );
  const InventoryReminderUserGroup = _InventoryReminderUserGroup.init(
    sequelize,
    DataTypes
  );
  const InventoryReminderUserGroupType = _InventoryReminderUserGroupType.init(
    sequelize,
    DataTypes
  );
  const InventoryRxPrescription = _InventoryRxPrescription.init(
    sequelize,
    DataTypes
  );
  ...
  const LabOrderAntechLabOrder = _LabOrderAntechLabOrder.init(
    sequelize,
    DataTypes
  );
  const LabOrderIdexxLabOrder = _LabOrderIdexxLabOrder.init(
    sequelize,
    DataTypes
  );
  ...
  const LabOrderZoetisRefLabOrder = _LabOrderZoetisRefLabOrder.init(
    sequelize,
    DataTypes
  );
  ...
  const PatientCategoricalAttr = _PatientCategoricalAttr.init(
    sequelize,
    DataTypes
  );
  const PatientCategoricalMeasurement = _PatientCategoricalMeasurement.init(
    sequelize,
    DataTypes
  );
  ...
  const PatientFreeformMeasurement = _PatientFreeformMeasurement.init(
    sequelize,
    DataTypes
  );
  ...
  const PatientNumericMeasurement = _PatientNumericMeasurement.init(
    sequelize,
    DataTypes
  );
  ...
  const ZoetisLabOrderTestItem = _ZoetisLabOrderTestItem.init(
    sequelize,
    DataTypes
  );
  ...
  Inventory.belongsToMany(BillingItem, {
    as: "billingItemIdBillingItems",
    through: BillingPackageItem,
    foreignKey: "inventoryId",
    otherKey: "billingItemId",
  });
  Patient.belongsToMany(PatientCategoricalAttr, {
    as: "patientCategoricalAttrIdPatientCategoricalAttrs",
    through: PatientCategoricalMeasurement,
    foreignKey: "patientId",
    otherKey: "patientCategoricalAttrId",
  });
  Patient.belongsToMany(PatientFreeformAttr, {
    as: "patientFreeformAttrIdPatientFreeformAttrs",
    through: PatientFreeformMeasurement,
    foreignKey: "patientId",
    otherKey: "patientFreeformAttrId",
  });
  Patient.belongsToMany(PatientNumericAttr, {
    as: "patientNumericAttrIdPatientNumericAttrs",
    through: PatientNumericMeasurement,
    foreignKey: "patientId",
    otherKey: "patientNumericAttrId",
  });
  PatientCategoricalAttr.belongsToMany(Patient, {
    as: "patientIdPatients",
    through: PatientCategoricalMeasurement,
    foreignKey: "patientCategoricalAttrId",
    otherKey: "patientId",
  });
  PatientFreeformAttr.belongsToMany(Patient, {
    as: "patientIdPatientPatientFreeformMeasurements",
    through: PatientFreeformMeasurement,
    foreignKey: "patientFreeformAttrId",
    otherKey: "patientId",
  });
  PatientNumericAttr.belongsToMany(Patient, {
    as: "patientIdPatientPatientNumericMeasurements",
    through: PatientNumericMeasurement,
  ...
  Appt.hasOne(ExamAnesthesiaGen, {
    as: "examAnesthesiaGen",
    foreignKey: "apptId",
  });
  ExamAnesthesiaMed.belongsTo(Appt, { as: "appt", foreignKey: "apptId" });
  Appt.hasMany(ExamAnesthesiaMed, {
    as: "examAnesthesiaMeds",
    foreignKey: "apptId",
  });
  ExamAnesthesiaVitalTrack.belongsTo(Appt, {
    as: "appt",
    foreignKey: "apptId",
  });
  Appt.hasMany(ExamAnesthesiaVitalTrack, {
    as: "examAnesthesiaVitalTracks",
    foreignKey: "apptId",
  });
  ...
  BillingPackageItem.belongsTo(BillingItem, {
    as: "billingItem",
    foreignKey: "billingItemId",
  });
  BillingItem.hasMany(BillingPackageItem, {
    as: "billingPackageItems",
    foreignKey: "billingItemId",
  });
  ...
  BillingPackageItem.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(BillingPackageItem, {
    as: "billingPackageItems",
    foreignKey: "branchId",
  });
  BillingPayment.belongsTo(Branch, { as: "branch", foreignKey: "branchId" });
  Branch.hasMany(BillingPayment, {
    as: "billingPayments",
    foreignKey: "branchId",
  });
  ...
  Branch.hasMany(CalendarBlockExcluded, {
    as: "calendarBlockExcludeds",
    foreignKey: "branchId",
  });
  CalendarBlockRepeat.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(CalendarBlockRepeat, {
    as: "calendarBlockRepeats",
    foreignKey: "branchId",
  });
  ...
  Branch.hasMany(ClockHistory, {
    as: "clockHistories",
    foreignKey: "branchId",
  });
  CommunicationHistory.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(CommunicationHistory, {
    as: "communicationHistories",
    foreignKey: "branchId",
  });
  ...
  Branch.hasMany(ExamAnesthesiaGen, {
    as: "examAnesthesiaGens",
    foreignKey: "branchId",
  });
  ExamAnesthesiaMed.belongsTo(Branch, { as: "branch", foreignKey: "branchId" });
  Branch.hasMany(ExamAnesthesiaMed, {
    as: "examAnesthesiaMeds",
    foreignKey: "branchId",
  });
  ExamAnesthesiaVitalTrack.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(ExamAnesthesiaVitalTrack, {
    as: "examAnesthesiaVitalTracks",
    foreignKey: "branchId",
  });
  ExamAnesthesiaVitalTrackValue.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(ExamAnesthesiaVitalTrackValue, {
    as: "examAnesthesiaVitalTrackValues",
    foreignKey: "branchId",
  });
  ExamCategoryMeasurement.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(ExamCategoryMeasurement, {
    as: "examCategoryMeasurements",
    foreignKey: "branchId",
  });
  ExamFreeformMeasurement.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(ExamFreeformMeasurement, {
    as: "examFreeformMeasurements",
    foreignKey: "branchId",
  });
  ExamNumericMeasurement.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(ExamNumericMeasurement, {
    as: "examNumericMeasurements",
    foreignKey: "branchId",
  });
  ...
  Branch.hasMany(InventoryPackage, {
    as: "inventoryPackages",
    foreignKey: "branchId",
  });
  InventoryPackageItem.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(InventoryPackageItem, {
    as: "inventoryPackageItems",
    foreignKey: "branchId",
  });
  InventoryPatientReminder.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(InventoryPatientReminder, {
    as: "inventoryPatientReminders",
    foreignKey: "branchId",
  });
  InventoryPatientReminderUser.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(InventoryPatientReminderUser, {
    as: "inventoryPatientReminderUsers",
    foreignKey: "branchId",
  });
  InventoryPatientReminderUserGroup.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(InventoryPatientReminderUserGroup, {
    as: "inventoryPatientReminderUserGroups",
    foreignKey: "branchId",
  });
  InventoryProcedure.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(InventoryProcedure, {
    as: "inventoryProcedures",
    foreignKey: "branchId",
  });
  InventoryReminder.belongsTo(Branch, { as: "branch", foreignKey: "branchId" });
  Branch.hasMany(InventoryReminder, {
    as: "inventoryReminders",
    foreignKey: "branchId",
  });
  InventoryRxPrescription.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(InventoryRxPrescription, {
    as: "inventoryRxPrescriptions",
    foreignKey: "branchId",
  });
  InventoryTestVendor.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(InventoryTestVendor, {
    as: "inventoryTestVendors",
    foreignKey: "branchId",
  });
  InventoryVaccine.belongsTo(Branch, { as: "branch", foreignKey: "branchId" });
  Branch.hasMany(InventoryVaccine, {
    as: "inventoryVaccines",
    foreignKey: "branchId",
  });
  LabOrder.belongsTo(Branch, { as: "branch", foreignKey: "branchId" });
  Branch.hasMany(LabOrder, { as: "labOrders", foreignKey: "branchId" });
  LabOrderAntechLabOrder.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(LabOrderAntechLabOrder, {
    as: "labOrderAntechLabOrders",
    foreignKey: "branchId",
  });
  LabOrderIdexxLabOrder.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(LabOrderIdexxLabOrder, {
    as: "labOrderIdexxLabOrders",
    foreignKey: "branchId",
  });
  LabOrderManual.belongsTo(Branch, { as: "branch", foreignKey: "branchId" });
  Branch.hasMany(LabOrderManual, {
    as: "labOrderManuals",
    foreignKey: "branchId",
  });
  LabOrderVendorOrder.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(LabOrderVendorOrder, {
    as: "labOrderVendorOrders",
    foreignKey: "branchId",
  });
  LabOrderZoetisRefLabOrder.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(LabOrderZoetisRefLabOrder, {
    as: "labOrderZoetisRefLabOrders",
    foreignKey: "branchId",
  });
  ...
  Branch.hasMany(PatientCategoricalMeasurement, {
    as: "patientCategoricalMeasurements",
    foreignKey: "branchId",
  });
  PatientExamFile.belongsTo(Branch, { as: "branch", foreignKey: "branchId" });
  Branch.hasMany(PatientExamFile, {
    as: "patientExamFiles",
    foreignKey: "branchId",
  });
  PatientFreeformMeasurement.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(PatientFreeformMeasurement, {
    as: "patientFreeformMeasurements",
    foreignKey: "branchId",
  });
  PatientHistory.belongsTo(Branch, { as: "branch", foreignKey: "branchId" });
  Branch.hasMany(PatientHistory, {
    as: "patientHistories",
    foreignKey: "branchId",
  });
  PatientMed.belongsTo(Branch, { as: "branch", foreignKey: "branchId" });
  Branch.hasMany(PatientMed, { as: "patientMeds", foreignKey: "branchId" });
  PatientNumericMeasurement.belongsTo(Branch, {
    as: "branch",
    foreignKey: "branchId",
  });
  Branch.hasMany(PatientNumericMeasurement, {
    as: "patientNumericMeasurements",
    foreignKey: "branchId",
  });
  PatientVaccine.belongsTo(Branch, { as: "branch", foreignKey: "branchId" });
  Branch.hasMany(PatientVaccine, {
    as: "patientVaccines",
    foreignKey: "branchId",
  });
  PatientWeight.belongsTo(Branch, { as: "branch", foreignKey: "branchId" });
  Branch.hasMany(PatientWeight, {
    as: "patientWeights",
    foreignKey: "branchId",
  });
  ...
  Branch.hasMany(ReminderHistory, {
    as: "reminderHistories",
    foreignKey: "branchId",
  });
  ReminderRepeat.belongsTo(Branch, { as: "branch", foreignKey: "branchId" });
  Branch.hasMany(ReminderRepeat, {
    as: "reminderRepeats",
    foreignKey: "branchId",
  });
  ...
  Branch.hasMany(UserBranchMapping, {
    as: "userBranchMappings",
    foreignKey: "branchId",
  });
  ...
  CommunicationHistory.belongsTo(Client, {
    as: "client",
    foreignKey: "clientId",
  });
  Client.hasMany(CommunicationHistory, {
    as: "communicationHistories",
    foreignKey: "clientId",
  });
  ...
  InventoryPatientReminder.belongsTo(Client, {
    as: "client",
    foreignKey: "clientId",
  });
  Client.hasMany(InventoryPatientReminder, {
    as: "inventoryPatientReminders",
    foreignKey: "clientId",
  });
  ...
  Client.hasMany(ReminderHistory, {
    as: "reminderHistories",
    foreignKey: "clientId",
  });
  ZoetisBranchSetting.belongsTo(Client, {
    as: "client",
    foreignKey: "clientId",
  });
  Client.hasMany(ZoetisBranchSetting, {
    as: "zoetisBranchSettings",
    foreignKey: "clientId",
  });
  ZoetisLabOrderOrphan.belongsTo(Client, {
    as: "client",
    foreignKey: "clientId",
  });
  Client.hasMany(ZoetisLabOrderOrphan, {
    as: "zoetisLabOrderOrphans",
    foreignKey: "clientId",
  });
  ...
  Exam.hasMany(ExamCategoryMeasurement, {
    as: "examCategoryMeasurements",
    foreignKey: "examId",
  });
  ExamFreeformMeasurement.belongsTo(Exam, { as: "exam", foreignKey: "examId" });
  Exam.hasMany(ExamFreeformMeasurement, {
    as: "examFreeformMeasurements",
    foreignKey: "examId",
  });
  ExamNumericMeasurement.belongsTo(Exam, { as: "exam", foreignKey: "examId" });
  Exam.hasMany(ExamNumericMeasurement, {
    as: "examNumericMeasurements",
    foreignKey: "examId",
  });
  BillingItem.belongsTo(Inventory, {
    as: "inventory",
    foreignKey: "inventoryId",
  });
  Inventory.hasMany(BillingItem, {
    as: "billingItems",
    foreignKey: "inventoryId",
  });
  BillingPackageItem.belongsTo(Inventory, {
    as: "inventory",
    foreignKey: "inventoryId",
  });
  Inventory.hasMany(BillingPackageItem, {
    as: "billingPackageItems",
    foreignKey: "inventoryId",
  });
  EstimateItem.belongsTo(Inventory, {
    as: "inventory",
    foreignKey: "inventoryId",
  });
  Inventory.hasMany(EstimateItem, {
    as: "estimateItems",
    foreignKey: "inventoryId",
  });
  InventoryAddOn.belongsTo(Inventory, {
    as: "inventory",
    foreignKey: "inventoryId",
  });
  Inventory.hasMany(InventoryAddOn, {
    as: "inventoryAddOns",
    foreignKey: "inventoryId",
  });
  InventoryLable.belongsTo(Inventory, {
    as: "inventory",
    foreignKey: "inventoryId",
  });
  Inventory.hasMany(InventoryLable, {
    as: "inventoryLables",
    foreignKey: "inventoryId",
  });
  InventoryLot.belongsTo(Inventory, {
    as: "inventory",
    foreignKey: "inventoryId",
  });
  Inventory.hasMany(InventoryLot, {
    as: "inventoryLots",
    foreignKey: "inventoryId",
  });
  InventoryPackageItem.belongsTo(Inventory, {
    as: "inventory",
    foreignKey: "inventoryId",
  });
  Inventory.hasMany(InventoryPackageItem, {
    as: "inventoryPackageItems",
    foreignKey: "inventoryId",
  });
  InventoryPatientReminder.belongsTo(Inventory, {
    as: "inventory",
    foreignKey: "inventoryId",
  });
  Inventory.hasMany(InventoryPatientReminder, {
    as: "inventoryPatientReminders",
    foreignKey: "inventoryId",
  });
  InventoryProcedure.belongsTo(Inventory, {
    as: "inventory",
    foreignKey: "inventoryId",
  });
  Inventory.hasMany(InventoryProcedure, {
    as: "inventoryProcedures",
    foreignKey: "inventoryId",
  });
  InventoryReminder.belongsTo(Inventory, {
    as: "inventory",
    foreignKey: "inventoryId",
  });
  Inventory.hasMany(InventoryReminder, {
    as: "inventoryReminders",
    foreignKey: "inventoryId",
  });
  LabOrderTest.belongsTo(Inventory, {
    as: "inventory",
    foreignKey: "inventoryId",
  });
  Inventory.hasMany(LabOrderTest, {
    as: "labOrderTests",
    foreignKey: "inventoryId",
  });
  PatientMed.belongsTo(Inventory, {
    as: "inventory",
    foreignKey: "inventoryId",
  });
  Inventory.hasMany(PatientMed, {
    as: "patientMeds",
    foreignKey: "inventoryId",
  });
  PatientVaccine.belongsTo(Inventory, {
    as: "inventory",
    foreignKey: "inventoryId",
  });
  Inventory.hasMany(PatientVaccine, {
    as: "patientVaccines",
    foreignKey: "inventoryId",
  });
  LabOrderIdexxLabOrder.belongsTo(LabOrder, {
    as: "labOrder",
    foreignKey: "labOrderId",
  });
  LabOrder.hasMany(LabOrderIdexxLabOrder, {
    as: "labOrderIdexxLabOrders",
    foreignKey: "labOrderId",
  });
  LabOrderTest.belongsTo(LabOrder, {
    as: "labOrder",
    foreignKey: "labOrderId",
  });
  LabOrder.hasMany(LabOrderTest, {
    as: "labOrderTests",
    foreignKey: "labOrderId",
  });
  LabOrderVendorOrder.belongsTo(LabOrder, {
    as: "labOrder",
    foreignKey: "labOrderId",
  });
  LabOrder.hasMany(LabOrderVendorOrder, {
    as: "labOrderVendorOrders",
    foreignKey: "labOrderId",
  });
  LabOrderZoetisRefLabOrder.belongsTo(LabOrder, {
    as: "labOrder",
    foreignKey: "labOrderId",
  });
  LabOrder.hasMany(LabOrderZoetisRefLabOrder, {
    as: "labOrderZoetisRefLabOrders",
    foreignKey: "labOrderId",
  });
  ZoetisLabOrderTestItem.belongsTo(LabOrder, {
    as: "labOrder",
    foreignKey: "labOrderId",
  });
  LabOrder.hasMany(ZoetisLabOrderTestItem, {
    as: "zoetisLabOrderTestItems",
    foreignKey: "labOrderId",
  });
  ...
  User.belongsTo(Organization, { as: 'org', foreignKey: "orgId"});
  ...
  CommunicationHistory.belongsTo(Patient, {
    as: "patient",
    foreignKey: "patientId",
  });
  Patient.hasMany(CommunicationHistory, {
    as: "communicationHistories",
    foreignKey: "patientId",
  });
  ...
  ExamAnesthesiaGen.belongsTo(Patient, {
    as: "patient",
    foreignKey: "patientId",
  });
  Patient.hasMany(ExamAnesthesiaGen, {
    as: "examAnesthesiaGens",
    foreignKey: "patientId",
  });
  ExamAnesthesiaMed.belongsTo(Patient, {
    as: "patient",
    foreignKey: "patientId",
  });
  Patient.hasMany(ExamAnesthesiaMed, {
    as: "examAnesthesiaMeds",
    foreignKey: "patientId",
  });
  ExamAnesthesiaVitalTrack.belongsTo(Patient, {
    as: "patient",
    foreignKey: "patientId",
  });
  Patient.hasMany(ExamAnesthesiaVitalTrack, {
    as: "examAnesthesiaVitalTracks",
    foreignKey: "patientId",
  });
  FileHistory.belongsTo(Patient, { as: "patient", foreignKey: "patientId" });
  Patient.hasMany(FileHistory, {
    as: "fileHistories",
    foreignKey: "patientId",
  });
  InventoryPatientReminder.belongsTo(Patient, {
    as: "patient",
    foreignKey: "patientId",
  });
  Patient.hasMany(InventoryPatientReminder, {
    as: "inventoryPatientReminders",
    foreignKey: "patientId",
  });
  ...
  Patient.hasMany(NoteHistory, {
    as: "noteHistories",
    foreignKey: "patientId",
  });
  PatientCategoricalMeasurement.belongsTo(Patient, {
    as: "patient",
    foreignKey: "patientId",
  });
  Patient.hasMany(PatientCategoricalMeasurement, {
    as: "patientCategoricalMeasurements",
    foreignKey: "patientId",
  });
  PatientExamFile.belongsTo(Patient, {
    as: "patient",
    foreignKey: "patientId",
  });
  Patient.hasMany(PatientExamFile, {
    as: "patientExamFiles",
    foreignKey: "patientId",
  });
  PatientFreeformMeasurement.belongsTo(Patient, {
    as: "patient",
    foreignKey: "patientId",
  });
  Patient.hasMany(PatientFreeformMeasurement, {
    as: "patientFreeformMeasurements",
    foreignKey: "patientId",
  });
  ...
  PatientNumericMeasurement.belongsTo(Patient, {
    as: "patient",
    foreignKey: "patientId",
  });
  Patient.hasMany(PatientNumericMeasurement, {
    as: "patientNumericMeasurements",
    foreignKey: "patientId",
  });
  PatientVaccine.belongsTo(Patient, { as: "patient", foreignKey: "patientId" });
  Patient.hasMany(PatientVaccine, {
    as: "patientVaccines",
    foreignKey: "patientId",
  });
  PatientWeight.belongsTo(Patient, { as: "patient", foreignKey: "patientId" });
  Patient.hasMany(PatientWeight, {
    as: "patientWeights",
    foreignKey: "patientId",
  });
  Reminder.belongsTo(Patient, { as: "patient", foreignKey: "patientId" });
  Patient.hasMany(Reminder, { as: "reminders", foreignKey: "patientId" });
  ReminderHistory.belongsTo(Patient, {
    as: "patient",
    foreignKey: "patientId",
  });
  Patient.hasMany(ReminderHistory, {
    as: "reminderHistories",
    foreignKey: "patientId",
  });
  PatientCategoricalMeasurement.belongsTo(PatientCategoricalAttr, {
    as: "patientCategoricalAttr",
    foreignKey: "patientCategoricalAttrId",
  });
  PatientCategoricalAttr.hasMany(PatientCategoricalMeasurement, {
    as: "patientCategoricalMeasurements",
    foreignKey: "patientCategoricalAttrId",
  });
  Patient.belongsTo(PatientColor, {
    as: "patientColor",
    foreignKey: "patientColorId",
  });
  PatientColor.hasMany(Patient, {
    as: "patients",
    foreignKey: "patientColorId",
  });
  PatientFreeformMeasurement.belongsTo(PatientFreeformAttr, {
    as: "patientFreeformAttr",
    foreignKey: "patientFreeformAttrId",
  });
  PatientFreeformAttr.hasMany(PatientFreeformMeasurement, {
    as: "patientFreeformMeasurements",
    foreignKey: "patientFreeformAttrId",
  });
  PatientNumericMeasurement.belongsTo(PatientNumericAttr, {
    as: "patientNumericAttr",
    foreignKey: "patientNumericAttrId",
  });
  PatientNumericAttr.hasMany(PatientNumericMeasurement, {
    as: "patientNumericMeasurements",
    foreignKey: "patientNumericAttrId",
  });
  ...
  Payment.hasMany(BillingPayment, {
    as: "billingPayments",
    foreignKey: "paymentId",
  });
  InventoryPatientReminderUser.belongsTo(Reminder, {
    as: "reminder",
    foreignKey: "reminderId",
  });
  Reminder.hasMany(InventoryPatientReminderUser, {
    as: "inventoryPatientReminderUsers",
    foreignKey: "reminderId",
  });
  InventoryPatientReminderUserGroup.belongsTo(Reminder, {
    as: "reminder",
    foreignKey: "reminderId",
  });
  Reminder.hasMany(InventoryPatientReminderUserGroup, {
    as: "inventoryPatientReminderUserGroups",
    foreignKey: "reminderId",
  });
  InventoryReminderUserGroup.belongsTo(Reminder, {
    as: "reminder",
    foreignKey: "reminderId",
  });
  Reminder.hasMany(InventoryReminderUserGroup, {
    as: "inventoryReminderUserGroups",
    foreignKey: "reminderId",
  });
  ReminderUser.belongsTo(Reminder, {
    as: "reminder",
    foreignKey: "reminderId",
  });
  Reminder.hasMany(ReminderUser, {
    as: "reminderUsers",
    foreignKey: "reminderId",
  });
  ...
  UserContact.belongsTo(User, { as: "user", foreignKey: "userId" });
  User.hasOne(UserContact, { as: "contact", foreignKey: "userId" });
